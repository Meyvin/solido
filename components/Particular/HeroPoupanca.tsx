        ...
        <div className="flex h-full items-center">
          <div className="max-w-[720px] text-white">
            ...
            <p
              ...
              "
            >
              Poupar é fácil com o Sólido! Estes produtos ajudam quem quer guardar
               dinheiro de forma segura e prática. O Sólido tem contas de poupança 
               para cada fim.
            </p>
          </div>
        </div>
